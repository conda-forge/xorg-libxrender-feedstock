About xorg-libxrender-feedstock
===============================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/xorg-libxrender-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/xorg-libxrender-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add xorg-libxrender
# for installing globally
pixi global install xorg-libxrender
```
...
It is possible to list all of the versions of `xorg-libxrender` available on your platform:
...
```
pixi search xorg-libxrender --channel conda-forge
```
